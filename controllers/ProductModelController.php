...
class ProductModelController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
                       Yii::$app->getSession()->setFlash('message_updated','Product Model has been successfully Created!');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
               Yii::$app->getSession()->setFlash('message_updated','Product Model has been successfully Updated!');
            return $this->redirect(['view', 'id' => $model->model_id]);
        }
